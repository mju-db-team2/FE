...
const Evaluations = () => {
    ...
    const evaluations = [
        { id: 1, type: 'PM', evaluator: '김개발', evaluatee: '이피엘', date: '2024-07-01', score: 9.2, comment: '이피엘 과장은 PL로서 팀을 잘 이끌고...' },
        { id: 3, type: 'PEER', evaluator: '이피엘', evaluatee: '김개발', date: '2024-07-02', score: 9.2, comment: '김개발 대리는 기술적으로 배울 점이...' },
        { id: 5, type: 'CLIENT', evaluator: '고객사(삼성전자)', evaluatee: '김개발', date: '2024-07-05', score: 9.2, comment: '프로젝트 관리 능력 탁월' },
    ];
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500">프로젝트 수행 인력에 대한 평가 내역을 관리합니다.</p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="divide-y divide-gray-200">
                    {filteredEvaluations.map((evalItem) => (
                        <div key={evalItem.id} className="p-6 hover:bg-gray-50 transition-colors">
                            <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-3">
                                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${evalItem.type === 'PM' ? 'bg-purple-100 text-purple-700' :
                                            evalItem.type === 'PEER' ? 'bg-blue-100 text-blue-700' :
                            ...
                            <div className="mb-2">
                                <span className="font-medium text-gray-900">{evalItem.evaluatee}</span>

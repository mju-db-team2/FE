        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    <Link to="/projects" className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
            ...
            <div>
                ...
                <div className="mt-2 text-gray-600 text-sm flex flex-wrap items-center gap-3">
                    <span className="inline-flex items-center gap-1"><Briefcase className="w-4 h-4" /> {project.code}</span>
                    <span className="inline-flex items-center gap-1"><User className="w-4 h-4" /> 발주처 {project.client}</span>
                    <span>{project.start} ~ {project.end}</span>
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${statusClass}`}>{project.status}</span>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-bold text-gray-900">프로젝트 인원 및 역할</h2>
                    </div>
